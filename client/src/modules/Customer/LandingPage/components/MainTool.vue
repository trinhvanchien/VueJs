<template>
  <section id="tool" class="tool position_relative">
    <div
      ...
      :style="{
        backgroundImage: 'url(' + vienPhai + ')'
      }"
    ></div>
    <div
      class="border--left position_absolute"
      :style="{
        backgroundImage: 'url(' + vienTrai + ')'
      }"
    ></div>
    <div class="ct">
      ...
      <div class="r content benefit">
        <div class="c_lg_6 c_md_12 mb_md_3 left">
          ...
          <div class="items d_flex align_items_center">
            ...
            <div class="text">
              <p>Dễ dàng quản lý nội dung bài đăng, chiến dich.</p>
            </div>
          </div>
          <div class="items d_flex align_items_center">
            <div class="icon">
            ...
            <div class="text">
              <p>Tăng tương tác và xây dựng tệp khách hàng tiềm năng</p>
            </div>
          </div>
          <div class="items d_flex align_items_center">
            <div class="icon">
...
export default {
  data() {
    return {
      vienTrai: require("@/core/assets/images/home/vientrai.png"),
      vienPhai: require("@/core/assets/images/home/vienphai.png"),
      benefit: require("@/core/assets/images/home/undraw_visual_data_b1wx.svg"),
      automatic: require("@/core/assets/images/home/undraw_setup_analytics_8qkl.svg")
    };
  },
  methods: {}
};
  ...
  .content {
    ...
    .right {
      ...
      .info {
        ...
        background-image: linear-gradient(to right, #10171d 0%, #0e1f2c 100%);
        text-align: center;
        font-size: 24px;
        line-height: 100px;
        border-radius: 50%;
