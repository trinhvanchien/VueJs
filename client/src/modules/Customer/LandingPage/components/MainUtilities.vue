<template>
  <section id="utilities" class="utilities ct">
    <div class="section--title-content mb_0">
      <h3 class="title">Tại sao nên chọn Hoot ?</h3>
    </div>
            ...
            <div class="function d_flex align_items_center items">
              <div class="left text">
                ...
                <div class="desc">
                  ...
                  những tiện ích tối ưu nhất cho khách hàng của Hoot
                </div>
              </div>
              <div
                class="right order"
    ...
    <div class="d_md_none d_block">
      <div class="content--options px_3">
        <div class="items display mb_4">
          <div class="title--why">Giao diện thân thiện</div>
          <div class="desc mb_2">
            Đội ngũ Hoot không ngừng cải tiến, nâng cấp nhằm xây dựng một hệ
...
export default {
  data() {
    return {
      ...
      // images of Utilities
      sliderUtilities: [
        require("@/core/assets/images/home/undraw_chore_list_iof3.svg"),
        require("@/core/assets/images/home/undraw_collecting_fjjl.svg"),
        require("@/core/assets/images/home/undraw_time_management_30iu.svg"),
        require("@/core/assets/images/home/undraw_task_31wc.svg")
      ]
    };
  },
  methods: {
