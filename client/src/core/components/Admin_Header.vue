...
import HeaderNotification from "./Popup_Notification";
...
export default {
  ...
  methods: {
    async logOut() {
      ...
      this.$router.push({ name: "admin_signin" });
    },
    toogleSidebar() {
  ...
  .header--right {
    ...
    .profile {
      .avatar--wrap {
        border: 1.5px solid #f7f7f7;
        &.avatar--default {
          background-color: rgba(39, 41, 44, 0.4);
          border: 1.5px solid #ed1c24;
          color: #ed1c24;
        }
      }
